    ...
    <nav className="bg-black h-32 z-10">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          <img src={Logo} className="h-20 w-20 rounded-full object-cover border border-gray-700" alt="SkillSync Logo" />
          <span className="self-center text-4xl font-semibold font-sans whitespace-nowrap text-white">SkillSync</span>
        </Link>
